...
Ein Problem, welches diese Architekturen besitzen, ist das Problem des verschwindenden Gradienten.
...
\myfigure{mteb.png}{Die einzelnen Datensätze in MTEB aus \cite{muennighoff2023}}{mteb}

\myfigure{mteb_screenshot.png}{Screenshhot des MTEB Leaderboards \cite{mteb}}{mteb_screenshot}
