...
GraphQL Abfrage um alle Download-Links zu den Episoden des Podcasts \qt{radioWissen} zu erhalten.
...
GraphQL Abfrage um alle Metadaten zu den Episoden des Podcasts \qt{radioWissen} zu erhalten.
Die Programset-ID verweist auf den speziellen Podcast.
...
GraphQL Abfrage um alle Transkripte zu den Episoden des Podcasts \qt{radioWissen}  zu erhalten.
Die Programset-ID verweist auf den speziellen Podcast.
...
Ein Beispielprompt um Fragen zur Evaluation der Embedding-Modelle zu erstellen.

\begin{itshape}
Kannst du 30 Fragen generieren, wie \qt{Wann werden Menschen auf dem Mars sein?} oder \qt{Wo wird urbaner Gartenbau betrieben?}
\end{itshape}
