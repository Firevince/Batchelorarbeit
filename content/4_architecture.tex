...
SpaCy verwendet dafür Statistische Methoden.


\subsection{Lemmatisierung vs. Stemming}
...
\subsection{Kompositatrennung Pyphen vs german compound splitter}
...
wäre die Euklidische Distanz $\frac{1}{\sqrt{2}}$, da $\sqrt{(0-(-1))^2 + (1-0)^2}=\frac{1}{\sqrt{2}}$
Dieses Distanzmaß ist sensibel gegenüber der Länge der Vektoren.
Wenn die Vektoren nicht normiert wurden, kann die Euklidische Distanz sehr groß werden und die Ergebnisse verfälschen.

\subsubsection{Dotproduct Similarity}
