...
Zum Beispiel hat die Episode \qt{Quantenphysik - Wahr, aber verrückt} den Downloadlink \url{https://media.neuland.br.de/file/1804047/c/feed/quantenphysik-wahr-aber-verrueckt.mp3} aber auch \url{https://media.neuland.br.de/file/2069613/c/feed/quantenphysik-wahr-aber-verrueckt-1.mp3}.
...
Über vier seperate Slurm-Jobs wurden die 2237 Episoden innerhalb von ca. 50 Stunden transkribiert.  
...
Für die zukünftige Verwendung dieses Systems im öffentlich rechtlichen Kontextes, würde es sich anbieten, weitere Podcastepisoden mittels Cloud computing zu transkribieren.
...
Sie ist ein Zusammenschluss von derzeit 68 Rundfunkanstalten in 56 Staaten Europas, Nordafrikas und Vorderasien mit Sitz in Genf. 
...
Für dieses Projekt könnte zunächst die Translation Funktion verwendet werden. 
